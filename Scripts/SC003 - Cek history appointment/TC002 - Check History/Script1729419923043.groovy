...
WebUI.verifyElementText(findTestObject('History/p_Result-Facility'), 'Tokyo CURA Healthcare Center')

WebUI.verifyElementText(findTestObject('History/p_Result-Apply'), 'Yes')

WebUI.verifyElementText(findTestObject('History/p_Result-Healthcare Program'), 'Medicare')

WebUI.verifyElementText(findTestObject('History/p_Result-Comment'), 'TEGUH ARDAMA')
