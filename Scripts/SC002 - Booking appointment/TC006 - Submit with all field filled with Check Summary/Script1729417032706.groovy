...
WebUI.setText(findTestObject('Make Appointment/input_Visit Date (Required)'), '20/10/2024')
...
WebUI.verifyMatch('Tokyo CURA Healthcare Center', 'Tokyo CURA Healthcare Center', false)

WebUI.verifyMatch('Yes', 'Yes', false)

WebUI.verifyMatch('Medicare', 'Medicare', false)

WebUI.verifyMatch('20/10/2024', '20/10/2024', false)

WebUI.verifyMatch('TEGUH ARDAMA', 'TEGUH ARDAMA', false)
